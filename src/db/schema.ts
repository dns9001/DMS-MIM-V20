...
export const callPlanItems = pgTable("call_plan_items", {
  id: text("id").primaryKey(),
  callPlanId: text("call_plan_id").notNull(),
  outletId: text("outlet_id").notNull(),
...
export const visits = pgTable("visits", {
  ...
  nonProductiveReasonId: text("non_productive_reason_id"),
  notes: text("notes"),
...
export const stockHandovers = pgTable("stock_handovers", {
  id: text("id").primaryKey(),
  handoverNumber: text("handover_number").notNull(),
  salesmanId: text("salesman_id").notNull(),
  officeId: text("office_id"),
