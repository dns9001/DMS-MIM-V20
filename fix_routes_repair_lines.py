...
new_block = """apiRouter.post("/stock/handovers", authMiddleware, requireRoles("WAREHOUSE", "ADMIN", "OWNER", "SUPERVISOR"), async (req: AuthenticatedRequest, res) => {
...
lines = lines[:9102] + [new_block] + lines[9379:]
